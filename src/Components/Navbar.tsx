    ...
    return (
        <nav className="bg-black text-blue-600 px-4 py-3 shadow-lg relative">
            ...
            <div className="flex justify-between items-center">
                ...
                {/* Buscador centrado absolutamente - solo desktop */}
                {onSearch && (
                    <form
                        onSubmit={handleSubmit}
                        className="hidden lg:flex absolute left-1/2 -translate-x-1/2 items-center text-sm gap-2 border border-gray-300 px-3 py-1 rounded-full"
                    >
                        <input
                ...
                {/* Links - derecha (desktop) + hamburguesa (móvil) */}
